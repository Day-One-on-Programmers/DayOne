...
public class M35 extends Car5{
     ...
     */
    M35(int speed, boolean operable, char grade, int price) {
     ...
     */
    M35(int speed, boolean operable, char grade) {
        super(speed, operable, grade);
        this.price = 0;
    }
     ...
     * - price는 0으로 초기화하세요
     */
    M35(int speed, boolean operable) {
    ...
    public static void main(String[] args) {
        M35 genesisCar = new M35(150, true);
...
class Car5 {
    ...
    Car5(int speed, boolean operable) {
